...
namespace FibonacciTest
{
    public partial class FibonacciForm : Form
    {
        ...
        private async void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            var test = await Task.WhenAll(task1, task2); // wait for both to complete
            ...
            //var test = task1.Result;
            outputTextBox.AppendText($"Test = { test[0].EndTime}\r\n\r\n");
            outputTextBox.AppendText($"Test2 = { test[1].EndTime}\r\n\r\n");
        }

        // starts a call to Fibonacci and caputres start/end times
        ...
        // Recursibely calculates Fibonacci numbers
